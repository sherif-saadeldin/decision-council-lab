...
VALID_DOSSIER_PAYLOAD = {
    ...
    "direct_answer": "Yes—ship with a narrow scope and explicit rollback plan for feature X.",
    "why_this_decision": ["Reason one", "Reason two", "Reason three"],
    "what_would_change_mind": ["Condition one", "Condition two", "Condition three"],
    "do_not_do": ["Do not expand scope", "Do not skip tests", "Do not skip approval"],
    "approval_gate": "Approve the scoped MVP and kill criteria before implementation pack work.",
    "confidence_score": 0.7,
    "kill_criteria": ["Kill"],
    "next_actions": ["Next one", "Next two", "Next three"],
    "open_questions": ["Open"],
